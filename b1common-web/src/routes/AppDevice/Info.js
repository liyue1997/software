  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        const { dispatch } = this.props;
        if (this.props.base.info.tDeviceseq) {
          dispatch({
            type: 'base/fetch',
            payload: {
              ...values,
...
{getFieldDecorator('tUserid', {
 initialValue: info.tUserid || newInfo.tUserid,
  rules: [
    {
      required: true,
      message: '用户id不能缺失!',
 ...
 <FormItem {...formItemLayout} hasFeedback label="设备序列号">
{getFieldDecorator('tDeviceseq', {
 initialValue: info.tDeviceseq || newInfo.tDeviceseq,
  rules: [
    {
      required: true,
      message: '设备序列号不能缺失!',
