      ...
      if (response) {
        if (response.code === '204') {
          ...
          if (response.data.extendInfo) {
            db.set('userType', response.data.extendInfo.userType);
            // db.set('zonecode', response.data.extendInfo.zonecode);
            // db.set('zonelon', response.data.extendInfo.zonelon);
            // db.set('zonelan', response.data.extendInfo.zonelan);
            // db.set('zonelevel', response.data.extendInfo.zonelevel);
          }
