...
const { Option } = Select;
//const routerUrl = cache.keysMenu.HdShopuser;
...
@Form.create()
@List.create()
export default class HdShopuserList extends Component {
  state = {
  ...
  render() {
    ...
    const listConfig = {
      url: '/api/HdShopuser/queryHdShopuserList', // 必填,请求url
        ...
        <Card bordered={false} style={{ marginBottom: 24 }} hoverable>
          <Form onSubmit={this.handleSearch} >
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
              ...
              <Col {...formItemGrid}>  <FormItem {...formItemLayout} label='用户工号'>{getFieldDecorator('user_number', { initialValue: this.props.list.queryMap.user_number, })(<Input placeholder='请输入' />)} </FormItem> </Col>
              ...
              <Col {...formItemGrid}> 
               <FormItem {...formItemLayout} label='门店'>
                {getFieldDecorator('shop_id', { initialValue: this.props.list.queryMap.zone_code, })
                  (<Select showSearch allowClear placeholder='门店'>
                    {datahdShop && datahdShop.map(item => {
                       //console.log(item)
                      return (
                        <Option
                          value={item.shop_id}
            ...
            <Col {...formItemGrid}>  <FormItem {...formItemLayout} label='用户电话'>{getFieldDecorator('user_tel', { initialValue: this.props.list.queryMap.user_tel, })(<Input placeholder='请输入' />)} </FormItem> </Col>
              <Col {...formItemGrid}>  <FormItem {...formItemLayout} label='用户QQ号'>{getFieldDecorator('user_qq', { initialValue: this.props.list.queryMap.user_qq, })(<Input placeholder='请输入' />)} </FormItem> </Col>
