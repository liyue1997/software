            ...
            <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="用户账户">
                  {getFieldDecorator('useraccount', {
                    initialValue: this.props.list.queryMap.useraccount,
              ...
              <Col {...formItemGrid}>
                ...
                <FormItem {...formItemLayout} label="验证码">
                  {getFieldDecorator('yzm', { initialValue: this.props.list.queryMap.yzm })(
                    <Input placeholder="请输入" />
                  )}{' '}
                </FormItem>{' '}
              </Col>
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="有效时间(起始)">
                  {getFieldDecorator('start_active_date', {
                    initialValue: this.props.list.queryMap.start_active_date
                      ? moment(this.props.list.queryMap.start_active_date)
                      : null,
              ...
              <Col {...formItemGrid}>
                {' '}
                <FormItem {...formItemLayout} label="有效时间(结束)">
                  {getFieldDecorator('end_active_date', {
                    initialValue: this.props.list.queryMap.end_active_date
                      ? moment(this.props.list.queryMap.end_active_date)
                      : null,
                  })(<DatePicker format={DateFormat} placeholder="请输入" />)}{' '}
                </FormItem>{' '}
              </Col>
