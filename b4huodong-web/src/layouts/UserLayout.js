...
const copyright = (
  <Fragment>
    <span className={styles.copyword}>
      Copyright <Icon type="copyright" /> 2019 {webConfig.companyName}出品
      <p>
        备案号:苏ICP备19011403号-1
   </p>
    </span>
        ...
        <div className={styles.container}>
          <div className={styles.content}>
            <div className={styles.top}>
              ...
              </div> <div className={styles.desc}>{webConfig.companyName}</div>*/}
            </div>
            <Switch>
