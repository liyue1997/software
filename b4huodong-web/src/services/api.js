...
export async function getMenuData() {
  ...
  var jsonobject = requestModels(`${SERVER_ADDR}/api/authority/getnewMenus`, {
    method: 'POST',
    body: {
      sysid: 'Z2',
    },
...
export async function queryData(params, url) {
  return requestModels(`${SERVER_ADDR}/api/${url}`, {
    method: 'POST',
    body: params,
  });
}
...
export async function getCosSigner(params) {
  return request(`${SERVER_ADDR}/cos/getCosSigner`, {
    method: 'POST',
    body: params,
  });
}

export async function saveImgOne(params) {
  return requestModels(`${SERVER_ADDR}/api/TPicture/saveImgOne`, {
    method: 'POST',
    body: params,
  });
}
export async function saveImgList(params) {
  return requestModels(`${SERVER_ADDR}/api/TPicture/saveImgList`, {
    method: 'POST',
    body: params,
  });
}
export async function getImgList(params) {
  return requestModels(`${SERVER_ADDR}/api/TPicture/getImgList`, {
    method: 'POST',
    body: params,
  });
}
...
export async function getAllList() {
  return requestModels(`${SERVER_ADDR}/api/TDic/getAllList`, {
    method: 'POST',
  });
}
// 请求用户类型下拉框数据
...
// 请求区域编码下拉框数据
export async function queryRsZoneList(params) {
  return requestModels(`${SERVER_ADDR}/api/RsZone/queryRsZoneList`, {
    method: 'POST',
    body: params,
  });
}
...
//请求echarts数据
export async function getchartsList(params) {
  return request(`${SERVER_ADDR}/api/RsDeviceReport/reportRsDeviceReportList`, {
    method: 'POST',
    body: params,
  });
}
//锁定
export async function lockdevices(params) {
  return request(`${SERVER_ADDR}/api/RsDevice/lockdevices`, {
    method: 'POST',
    body: params,
  });
}
//解除锁定
export async function unlockdevices(params) {
  return request(`${SERVER_ADDR}/api/RsDevice/unlockdevices`, {
    method: 'POST',
    body: params,
  });
}
