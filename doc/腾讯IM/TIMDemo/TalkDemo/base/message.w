...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full x-cards"
   ...
   <span xid="span10"></span></a></div>  
        ...
        <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="发送图片" xid="button5" onClick="button5Click" style="display:none;">
   <i xid="i12"></i>
   <span xid="span11">发送图片</span></a>
  <input type="file" value="" xid="imgfile" style="display:none;" bind-change="imgfileChange"></input>
  <input type="file" id="imagePicker" ref="imagePicker" accept=".jpg, .jpeg, .png, .gif" bind-change="imgfileChange" style="display:none" />
  </div> 
      </div> 
    </div>  
  ...
  <div component="../lib/superInput/superInput" xid="superinput" class="x-superinput"
    onSend="okBtnClick" onFinishRecVoice="fileChange"> 
     ...
     <div class="x-flex1 x-input-area" style="overflow:auto"> 
      ...
      <div class="x-superinput-right" xid="emojiRightBtn"> 
        ...
        <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon x-btn-voice"
          label="" icon="icon-ios7-mic-outline" style="margin-top:-6px"> 
        ...
        <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full"
          ...
          <div class="x-contents-content" xid="attachment"> 
            <div class="x-superinput-attachment container-fluid "> 
              <div class="row grid"> 
                <div class="col cell col-xs-3 col-md-2 text-center" bind-click="button5Click"> 
                  <div class="x-fileInput"> 
                    <!--<input type="file" multiple="true" xid="photoInput" accept="image/*,doc/-"/>  -->
                    <input xid="photoInput" type="file" multiple="false" id="imagePicker" ref="imagePicker" accept="image/*" bind-change="imgfileChange" style="display:none" /> 
                  </div>  
                 ...
                 <div class="col cell col-xs-3 col-md-2 text-center" bind-click="button6Click"> 
                  <div class="x-fileInput"> 
                    <input type="file" multiple="false" xid="audioInput" accept="audio/*" id="filePicker" ref="filePicker" bind-change="fileChange" style="display:none"/> 
                  </div>  
                ...
                <div class="col cell col-xs-3 col-md-2 text-center" bind-click="button6Click"> 
                 ...
                 <div class="col cell col-xs-3 col-md-2 text-center" bind-click="button6Click"> 
                  <div class="x-fileInput"> 
                    ...
                    <input xid="fileInput" multiple="false" type="file" id="filePicker" ref="filePicker" accept="*/*" bind-change="fileChange" style="display:none" />
                  </div>  
