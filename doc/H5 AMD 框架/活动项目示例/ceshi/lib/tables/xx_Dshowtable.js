define(function(require) {
	...
	xx_Dshowtable.prototype.init = function(option) {
		var self = this;

		self.option = $.extend({}, options, option);

		var xx_Dshowtable = "<table id='xx_Dshowtable'><thead id='xx_Dshowthead'><tr></tr></thead></table><p>-加载更多-</p>";
	...
	xx_Dshowtable.prototype.getinfos = function() {
		...
		me.option.getPageData(me.option.curpage, me.option.pagelen, function(data) {
			...
			//			document.getElementById("page").value=me.option.curpage+1;
		});
		$("#msgtable p").click(function() {
			me.getNextinfos();
		});

	}
	xx_Dshowtable.prototype.getNextinfos = function(getPageData) {
		me.option.curpage + 1;
		me.getinfos();
	}

	return new xx_Dshowtable();
});