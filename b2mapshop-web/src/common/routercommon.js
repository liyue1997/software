const commonroute = (app, dynamicWrapper) => ({
  ...
  '/TsUserSetting/list': {  component: dynamicWrapper(app, [], () => import('../routes/TsUserSetting/List')),  },
  '/TsUserSetting/info': {  component: dynamicWrapper(app, [], () => import('../routes/TsUserSetting/Info')),  },
