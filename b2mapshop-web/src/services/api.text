...
export async function getCosSigner(params) {
  return requestCosAuth(`${SERVER_ADDR}/cos/getCosSigner`, {
    method: 'POST',
    body: params,
  });
}
...
export async function saveImgL(params) {
...
export async function getImgOne(params) {
  return requestModels(`${SERVER_ADDR}/api/TPicture/getImgOne`, {
    method: 'POST',
    body: params,
  });
}
