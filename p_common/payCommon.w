...
<img src="$UI/lxmholiday/common/image/2.jpg" alt="" xid="image1" style="display:none;"></img>
  <span component="$UI/system/components/justep/windowReceiver/windowReceiver" xid="windowReceiver1" onReceive="windowReceiver1Receive" style="top:10px;left:42px;"></span><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full paymentPanel x-has-iosstatusbar" xid="paymentPanel">
   ...
   <div class="x-panel-content payPanelContent" xid="content1"><div component="$UI/system/components/justep/row/row" class="x-row" xid="zfbPayRow" bind-visible="zfbvisible">
   <div class="x-col x-col-fixed x-col-center" xid="col2" style="width:auto;">
    <img src="$UI/p_common/img/fluck-zfbpay.png" alt="" xid="image2" style="width:30px;"></img></div> 
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="wxPayRow" bind-visible="weixinvisible">
   <div class="x-col x-col-fixed x-col-center" xid="col6" style="width:auto;">
    <img src="$UI/p_common/img/fluck-wxpay.png" alt="" xid="image3" style="width:30px;"></img></div> 
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="unionPayRow" bind-visible="zfbwapvisible">
   <div class="x-col x-col-fixed x-col-center" xid="col9" style="width:auto;">
    <img src="$UI/p_common/img/fluck-unionpay.png" alt="" xid="image4" style="width:30px;"></img></div> 
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row moneyRow" xid="moneyRow">
   ...
   <div class="x-col" xid="col1" style="padding:0px 0px 0px 0px;"><span xid="span6" style="color:#FF0000;font-size:large;"><![CDATA[fsdfds]]></span></div>
