    ...
    <div class="x-panel-content" xid="msgListContent" bind-touchend="msgListContentTouchend"> 
      <div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView"
        ...
        <div class="x-scroll-content" xid="scrollHeight"> 
          ...
          <div bind-if="val('fStyle') === 'hongbao'"  bind-click="btnhbclick1">                        
                       <div class="x-col x-col-fixed" style="width:auto;" xid="col2"  > <!--bind-click="contactInfo"  -->
                            <div xid="div13" bind-text=" val(&quot;fSenderTime&quot;)"  style="width:55px;"/> 
                         <!--  <img alt="" bind-attr-src="$model.getImageUrl(val('fImg'))" xid="image6"/>  -->
                             
                        </div>  
                        <div class="x-col" style="position:relative;clear:right;height:200px;"> 
                 <div xid="div100" style="position:absolute;" bind-html="ref('fContent')"/> 
                  <div  xid="div101" class="x-col-center" style="color:#e9c71c;position:relative;top:120px;z-index:1;left:50px;width:140px;" bind-html="ref('fMessageText')"/>                
             </div>
          </div>  
           
                
                <!-- <div  bind-if="val('fStyle') === 'hongbao'"> 
               <div class="media" bind-if="val('isOut')" bind-click="btnhbclick1"> 
                    <div xid="div105" class="media-body text-right o-messageBox2"> 
                      <div xid="div104" bind-text=" val(&quot;fSenderTime&quot;)" class="x-ownSenderMessageTime"/>  
                     <i bind-css="{'icon-loading-c':val(&quot;fState&quot;)===&quot;pending&quot;,'icon-checkmark':val(&quot;fState&quot;)===&quot;sent&quot;||val(&quot;fState&quot;)===&quot;received&quot;||val(&quot;fState&quot;)===&quot;read&quot;,'x-recvied':val(&quot;fState&quot;)===&quot;recevied&quot;,'x-read':val(&quot;fState&quot;)===&quot;read&quot;,'icon-alert x-error':val(&quot;fState&quot;)===&quot;error&quot;}"
                        class="x-state"/>   
                    <div xid="div108" class="x-attention" bind-if=" val(&quot;fIsOwnSet&quot;)"> 
                        <i xid="i108" class="icon-heart" style="float:right;"/>  
                        <span xid="span200" bind-text=" val(&quot;fAttentionNum&quot;)+&quot;+&quot;"
                    ...
                    <div bind-if="val(&quot;fStyle&quot;)===&quot;photo&quot;&amp;&amp;!val(&quot;fileUrl&quot;) "> 
                      ...
                      <div style="position:relative;clear:right;"> 
                        ...
                        <span xid="me110" class="text-left " bind-html="ref('fContent')"/> 
                         <div  xid="div101" class="text-right " bind-html="ref('fMessageText')"/> 
                      
                      </div> 
                    </div>  
                    <div xid="div401" class="media-right"> 
                      <div component="$UI/system/components/justep/row/row"
                        class="x-row x-row-center" xid="row20" style="padding:0px;"> 
                        <div class="x-col" xid="col4100"> 
                ...
                <div bind-if="val('fStyle') !== 'service'  &amp;&amp; val('fStyle') !== 'hongbao' "> 
      ...
      <div class="x-superinput-right" xid="emojiRightBtn"> 
       ...
       <!--  <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon x-btn-send hide"
        ...
        <i class="iconfont icon-right"/>  
         ...
         <a component="$UI/system/components/justep/button/button" class="x-btn-send hide"
        label="" icon="">
          ...
          <div class="x-contents-content" xid="attachment"> 
            <div class="x-superinput-attachment container-fluid "> 
              <div class="row grid"> 
                ...
                <div class="col cell col-xs-3 col-md-2 text-center" bind-click="btnhbclick" bind-visible="$model.isshowcb()"> 
                  <div class="x-fileInput" > 
                    
                  </div>  
                  <i class="iconfont icon-wenjianjia x-file"/>  
                  <h5 class="text-muted text-center"><![CDATA[发宠币 ]]></h5> 
                </div> 
              </div> 
            </div> 
          </div> 
...
<span component="$UI/system/components/justep/windowDialog/windowDialog" xid="hbwindowDialog" onReceive="hbwindowDialogReceive"></span></div>
