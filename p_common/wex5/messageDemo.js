define(function(require) {
	...
	var PhotoSwipe = require("$UI/p_common/lib/photoswipe/photoswipe.min");
	var PhotoSwipeUI_Default = require("$UI/p_common/lib/photoswipe/photoswipe-ui-default.min");
	var electronApp = require("$UI/p_common/lib/electron-app");
	var store = require('$UI/system/lib/base/store');
	
	require('css!$UI/p_common/lib/photoswipe/photoswipe').load();
	require('css!$UI/p_common/lib/photoswipe/default-skin').load();
