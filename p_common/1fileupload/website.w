...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel2">
   <div class="x-panel-top" xid="top2">
    <div component="$UI/system/components/justep/titleBar/titleBar" title="banner" class="x-titlebar" xid="titleBar1">
     ...
     <div class="x-titlebar-title" xid="title1">banner</div>
     <div class="x-titlebar-right reverse" xid="right1"></div></div> </div> 
   <div class="x-panel-content" xid="content2">
    <iframe src="" xid="iframe1" width="100%" height="100%" frameborder="0" class="iframe"></iframe></div> </div></div>