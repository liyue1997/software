...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
   ...
   <div class="x-col x-col-20" xid="col1" style="text-align:center;">
  <img src=" " alt="" xid="headimg" class="headimg" bind-attr-src=' val("headimg")'></img><span xid="unread" class="unreadcount" bind-text='val("unreadcount")' bind-visible=' $model.tipshow( val("unreadcount"))'><![CDATA[未读消息数]]></span></div>
   ...
   <div class="x-col x-col-20" xid="col3"><span xid="lasttime" bind-text=' val("lastTime")' class="lasttime"></span></div>
   </div>
   </div></div> </div> 
  </div> 
