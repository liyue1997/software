...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full x-cards"
   ...
   <span xid="span10"></span></a></div>  
        ...
        <div class="x-titlebar-title " xid="title1" style="text-align: center;"> 
          <div component="$UI/system/components/justep/output/output" class="form-control input-sm o-name"
            xid="typing" style="padding-top: 3px;text-align:center;" bind-text="grouptitle"/> 
        </div>  
      ...
      <div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView"
        ...
        <div class="x-scroll-content" xid="scrollHeight"> 
          <div component="$UI/system/components/justep/list/list" class="x-list"
            ...
            onAfterRender="msgListAfterRender" limit="-1"> 
  ...
  <div component="../lib/superInput/superInput" xid="superinput" class="x-superinput"
    onSend="okBtnClick" onFinishRecVoice="superInputFinishRecVoice" id="superinputArea" bind-click="showinscorl"> 
    <div class="x-flex x-superinput-area" xid="superinputArea"> 
     ...
     <div class="x-flex1 x-input-area" style="overflow:auto"> 
      ...
      <div class="x-superinput-right" xid="emojiRightBtn"> 
        <a component="$UI/system/components/justep/button/button" class="btn btn-only-icon btn-link x-btn-emoji"
          label="" icon="dataControl dataControl-undo1"> 
        ...
        <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon x-btn-voice"
          label="" icon="icon-ios7-mic-outline" style="margin-top:-6px" bind-click="button8Click"> 
          <i class="icon-ios7-mic-outline"/>  
          <span/> 
        </a>  
        ...
        <i class="iconfont icon-right"/>  
         ...
         <a component="$UI/system/components/justep/button/button" class="x-btn-send hide" label="发送">    
        <i /> 
          <span/> 
        </a>
      </div> 
        ...
        <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full"
          ...
          <div class="x-contents-content" xid="attachment"> 
            <div class="x-superinput-attachment container-fluid "> 
              <div class="row grid gridicons"> 
                <div class="col cell col-xs-3 col-md-2 text-center" bind-click="button9Click"> 
                    <div class="x-fileInput">
                    	<input xid="imgInput" multiple="false" type="file" id="imgPicker" ref="imgPicker" accept="image/*,doc/-" bind-change="imgChange" style="display:none" /> 
                  	</div>
                  <i class="linear linear-picture x-file"/>  
                  <h5 class="text-muted text-center"><![CDATA[拍照 ]]></h5> 
                </div>  
                 <div class="col cell col-xs-3 col-md-2 text-center" bind-click="button8Click"> 
                    <div class="x-fileInput">
                    	<input xid="voiceInput" type="file" id="voicePicker" ref="voicePicker" accept="audio/*,doc/-" capture="microphone" bind-change="voiceChange" style="display:none"/> 
                  	</div>
                  <i class="icon-ios7-mic x-file"/>  
                  <h5 class="text-muted text-center"><![CDATA[语音 ]]></h5> 
                </div>  
                <div class="col cell col-xs-3 col-md-2 text-center" bind-click="button7Click">  
                    <div class="x-fileInput">
                    	<input xid="cameraInput" multiple="false" type="file" id="videoPicker" ref="videoPicker" accept="video/*,doc/-" capture="camera" bind-change="videoChange" style="display:none"/> 
                  	</div>
                  <i class="linear linear-camera x-file"/>  
                  <h5 class="text-muted text-center"><![CDATA[摄像 ]]></h5> 
                </div>  
                 <div class="col cell col-xs-3 col-md-2 text-center" bind-click="button6Click"> 
                    <div class="x-fileInput">
                    	<input xid="wenInput" multiple="false" type="file" id="filePicker" ref="filePicker" bind-change="fileChange" style="display:none" />
                  	</div>
                  <i class="icon-folder x-file"/>  
