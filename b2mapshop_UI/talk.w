...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1" style="background-color:#252330;">
   ...
   <div class="x-col x-col-10" xid="col1"><a component="$UI/system/components/justep/button/button" label="" class="btn btn-link btn-only-icon" icon="img:$UI/b2mapshop_UI/img/nav_icon_fanhui.png" onClick="gotomainpage" xid="backBtn">
   <img src="$UI/b2mapshop_UI/img/nav_icon_fanhui.png" xid="image3" style="width:20px;"></img>
   <span xid="span1"></span></a></div>
   <div class="x-col x-col-80" xid="col2"><p class="title" xid="title1" style="font-size:18px;text-align:center;" bind-text=' $model.discData.val("shop_fullname")'><![CDATA[百果园（六朝路店）]]></p></div>
   <div class="x-col x-col-10" xid="col3" bind-click="col3Click"><img src="./img/nav_icon_shangjia.png" alt="" xid="image1" style="width:20px;" class="backtoshop"></img></div></div></div>
   ...
   <div class="x-col x-col-67" xid="col4"><h4 xid="h41" style="color:#FFFFFF;font-size:18px;" bind-text=' $model.discData.val("discount_name")' class="discounttitle"><![CDATA[6人成团享9折]]></h4>
  
  
  </div>
   <div class="x-col x-col-33" xid="col6" style="text-align:center;padding-top:15px;">
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
   <div class="x-col" xid="col5"><p xid="p1" style="color:#FFFFFF;font-size:13px;" bind-text=' $model.discData.val("discount_desc")'><![CDATA[6人拼团 进口商品除外 周一至周五可用]]></p><div xid="div2" bind-html=" $model.showheads()"></div></div>
   ...
   <button xid="btnjoin" class="join" bind-visible=" $model.hasjoin()" bind-click="btnjoinClick" style="margin-right:19px;"><![CDATA[加入]]></button>
   <button xid="btnstart" class="join" bind-visible="!$model.hasteam()" bind-click="btnstartClick" style="margin-right:19px;"><![CDATA[发起]]></button>
   <button xid="button2" class="btn2" bind-click="button2Click" bind-visible=" $model.hascancle()" style="margin-right:19px;">取消</button>
  <button xid="button1" class="join" bind-visible=" $model.finish()" bind-click="button1Click" style="margin-right:19px;"><![CDATA[评价]]></button>
  <button xid="button3" class="join" bind-visible=" $model.hasteam()" bind-click="button3Click"><![CDATA[聊天]]></button></div></div></div>
  </div>
  <div xid="dialog"></div>
