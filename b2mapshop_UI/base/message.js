define(function(require) {
	...
	//应该是获取当前会话
	Model.prototype.getPeer=function(id,type)
	{
	    //return IM.getPeer(id, type);
	...
	Model.prototype.modelModelConstructDone = function(event) {
		if (this.params) {
			...
			self.params.main.pushMsgReceived=function(message){
				console.log("peer.main.pushMsgReceived",message);
			};
			var initPeer = function(id) {
				self.curPeer =self.getPeer(id, type);
...
//			}
	...
	Model.prototype.attentionBtnClick = function(event) {
		...
		var option = {
			...
			senderID : TIM.getPerson(msgPopMenu._fSenderPID).uid,
