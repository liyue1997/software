define(function(require) {
	...
	function success(data){
	     var translateCallback = function(datanew) {
	        ttool.showmsg("map  translate  success");
			if (datanew.status === 0) {
			    var datanew1={};
			    datanew1.coords={};
    ...
    function success1(data){
       ...
       // self.dingwei(data.coords.longitude,data.coords.latitude);
	     ...
	     geoc.getLocation(point, function(rs){
	                    ...
	                    var point={"lng":data.coords.longitude,"lat":data.coords.latitude,"url":ttool.getpicformap("")  ,
			           	        	   "id":"1","name":"我","address":addComp.province + ", " + addComp.city + ", " + addComp.district + ", " + addComp.street + ", " + addComp.streetNumber};
			           	   		        self.addMarker(map,point,"我");
...
*/
	...
	Model.prototype.loadBaiduMap = function(cityname) {
		...
		require([ 'http://api.map.baidu.com/api?v=2.0&ak=WrBlYTOPfTRFhfjIK9EXmaYVjMF1a9d5&callback=_baiduInit' ], function() {
	...
	Model.prototype.showgginfo=function(){
	    ...
	    if (gg!=="")
	    {
		     ...
		     $(self.getElementByXid("button1")).show();
		     }
	    }
