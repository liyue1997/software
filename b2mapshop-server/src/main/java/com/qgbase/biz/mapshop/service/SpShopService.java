 ...
 * * 主要用于：商铺 业务处理，此代码为自动生成
 */
@Component
public class SpShopService extends TBaseBo<SpShop>{
    @Autowired
    CommonDao commonDao;

    @Override
    public SpShop createObj() {
        return new SpShop();
    }
    @Override
    ...
    @Override
    public SpShop newObj(OperInfo oper) throws Exception {
        SpShop obj =  super.newObj(oper);
	...
	@Override
    public String checkAddorUpdate(SpShop obj, OperInfo oper, boolean isNew) throws Exception {
	 ...
	 @Override
    public String checkDelete(SpShop obj, OperInfo oper) throws Exception  {
